...
const ThirdLevel = ({ circleData, onClick, bounds, setBounds, compFlip, setflipFromCompo }) => {
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="#bababa"
      />
      <rect x="425" y="317" width="79" height="11" fill="#bababa" />
      <rect x="425" y="254" width="79" height="11" fill="#bababa" />
      <rect x="425" y="296" width="79" height="11" fill="#bababa" />
      <rect x="425" y="275" width="79" height="11" fill="#bababa" />
      <rect
        x="591.951"
        y="587.794"
        width="79"
      ...
      <g
        ...
        cy="413.199"
      >
        <circle cx="810.169" cy="413.199" r="125" fill="#683A96" />
        <circle
          cx="810.169"
          cy="413.199"
          r="130"
      ...
      <g
        ...
        cy="130"
      >
        <circle cx="465" cy="130" r="125" fill="#683A96" />
        <circle
          cx="465"
          cy="130"
          r="130"
        ...
        <DynamicForeignObj
          ...
          r="125"
          text={
            !compFlip ? content.circle_one_content.content_1 : content.circle_one_content.content_2
          }
        />
      </g>
      <g
        ...
        cy="765.27"
      >
        <circle cx="660.11" cy="765.27" r="125" fill="#683A96" />
        <circle
          cx="660.11"
          cy="765.27"
          r="130"
      ...
      <g
        ...
        cy="774.745"
      >
        <circle cx="299.802" cy="774.745" r="125" fill="#683A96" />
        <circle
          cx="299.802"
          cy="774.745"
          r="130"
      ...
      <g
        ...
        cy="407.536"
      >
        <circle cx="130.536" cy="407.536" r="125" fill="#683A96" />
        <circle
          cx="130.536"
          cy="407.536"
          r="130"
      ...
      <g
        ...
        cy="477"
      >
        <circle cx="469" cy="477" r="150" fill="#683A96" />
        <circle
          cx="469"
          cy="477"
          r="152.5"
        ...
        <DynamicForeignObj
          ...
          r="150"
          text={
            !compFlip ? content.circle_six_content.content_1 : content.circle_six_content.content_2
          }
        />
      </g>
    </svg>
