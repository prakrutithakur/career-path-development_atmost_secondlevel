...
const SixthLevel = ({
  ...
  return (
    ...
    >
      ...
      >
        <circle cx="465" cy="470" r="125" fill="#683A96" />
        <circle
          cx="465"
          cy="470"
          r="130"
      ...
      <g
        ...
        cy="286"
      >
        <circle cx="185" cy="286" r="125" fill="#683A96" />
        <circle
          cx="185"
          cy="286"
          r="130"
      ...
      <g
        ...
        cy="666.659"
      >
        <circle cx="191.959" cy="666.659" r="125" fill="#683A96" />
        <circle
          cx="191.959"
          cy="666.659"
          r="130"
      ...
      <g
        ...
        cy="813"
      >
        <circle cx="465" cy="813" r="125" fill="#683A96" />
        <circle
          cx="465"
          cy="813"
          r="130"
      ...
      <g
        ...
        cy="667"
      >
        <circle cx="744" cy="667" r="125" fill="#683A96" />
        <circle
          cx="744"
          cy="667"
          r="130"
      ...
      <g
        ...
        cy="286.341"
      >
        <circle cx="737.617" cy="286.341" r="125" fill="#683A96" />
        <circle
          cx="737.617"
          cy="286.341"
          r="130"
