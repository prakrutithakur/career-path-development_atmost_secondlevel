...
const FirstLevel = ({
  ...
  return (
    ...
    >
      ...
      {/* <text transform="translate(389.464 105)" fill="#E07127" xml:space="preserve" style="white-space: pre" fontFamily="Poppins" fontSize="24" fontWeight="600" letterSpacing="0em"><tspan x="16.3477" y="21.9">PRACTICE </tspan><tspan x="5.9297" y="48.9">STATEMENT</tspan></text> */}
      <rect
        x="604.172"
        y="554.904"
        width="79"
      ...
      {/* <text transform="translate(613.48 713.091) rotate(-15)" fill="#E07127" xml:space="preserve" style="white-space: pre" fontFamily="Poppins" fontSize="23" fontWeight="600" letterSpacing="0em"><tspan x="5.063" y="21.55">EDUCATION AND </tspan><tspan x="32.2857" y="48.55">EXPERIENCE</tspan></text> */}
      <rect
        width="79"
        height="11"
      ...
      {/* <text transform="matrix(-0.965926 -0.258819 -0.258819 0.965926 312.556 713.091)" fill="#E07127" xml:space="preserve" style="white-space: pre" fontFamily="Poppins" fontSize="23" fontWeight="600" letterSpacing="0em"><tspan x="5.063" y="21.55">EDUCATION AND </tspan><tspan x="32.2857" y="48.55">EXPERIENCE</tspan></text> */}
      <g
        id={4}
        onClick={(e) => {
          e.stopPropagation();
        ...
        // style={{ cursor: "pointer" }}
      >
        <circle cx="463.464" cy="477" r="150" fill="#E07127" />
        <DynamicForeignObject
          cx="463.464"
          cy="477"
          r="150"
