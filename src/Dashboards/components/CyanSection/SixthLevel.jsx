...
const SixthLevel = ({ onClick, circleData, levelSixBounds, setLevelSixBounds, compFlip }) => {
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="#D9D9D9"
      />
      <rect width="79" height="11" transform="matrix(1 0 0 -1 426.294 690.567)" fill="#D9D9D9" />
      <rect width="79" height="11" transform="matrix(1 0 0 -1 426.294 669.567)" fill="#D9D9D9" />
      <rect
        width="79"
        height="11"
      ...
      <rect
        ...
        fill="#D9D9D9"
      />
      <rect width="79" height="11" transform="matrix(1 0 0 -1 426.294 648.567)" fill="#D9D9D9" />
      <rect width="79" height="11" transform="matrix(1 0 0 -1 426.294 627.567)" fill="#D9D9D9" />
      <rect width="79" height="11" transform="matrix(1 0 0 -1 426.294 606.567)" fill="#D9D9D9" />
      <g id={7} cx="465" cy="470">
        <circle cx="465" cy="470" r="125" fill="#19447B" />
        <circle
          cx="465"
          cy="470"
          r="127.5"
        ...
        <DynamicForeignObj
          ...
          r="125"
          text={
            !compFlip ? content.circle_two_content.content_2 : content.circle_two_content.content_2
          }
        />
      </g>
      <g
        ...
        cy="286"
      >
        <circle cx="185" cy="286" r="125" fill="#19447B" />
        <circle
          cx="185"
          cy="286"
          r="127.5"
      ...
      <g
        ...
        cy="666.659"
      >
        <circle cx="191.959" cy="666.659" r="125" fill="#19447B" />
        <circle
          cx="191.959"
          cy="666.659"
          r="127.5"
      ...
      <g
        ...
        cy="813"
      >
        <circle cx="465" cy="813" r="125" fill="#19447B" />
        <circle
          cx="465"
          cy="813"
          r="127.5"
      ...
      <g
        ...
        cy="667"
      >
        <circle cx="744" cy="667" r="125" fill="#19447B" />
        <circle
          cx="744"
          cy="667"
          r="127.5"
      ...
      <g
        ...
        cy="286.341"
      >
        <circle cx="737.617" cy="286.341" r="125" fill="#19447B" />
        <circle
          cx="737.617"
          cy="286.341"
          r="127.5"
      ...
      <g
        ...
        cy="130"
      >
        <circle cx="465" cy="130" r="125" fill="#19447B" />
        <circle
          cx="465"
          cy="130"
          r="127.5"
