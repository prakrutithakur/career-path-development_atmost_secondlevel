  ...
  return (
    ...
    >
      ...
      <g
        ...
        cy="413.199"
      >
        <circle cx="810.169" cy="413.199" r="125" fill="#19447B" />
        <circle
          cx="810.169"
          cy="413.199"
          r="127.5"
      ...
      <g
        ...
        cy="765.27"
      >
        <circle cx="660.11" cy="765.27" r="125" fill="#19447B" />
        <circle
          cx="660.11"
          cy="765.27"
          r="127.5"
      ...
      <g
        ...
        cy="774.745"
      >
        <circle cx="299.802" cy="774.745" r="125" fill="#19447B" />
        <circle
          cx="299.802"
          cy="774.745"
          r="127.5"
      ...
      <g
        ...
        cy="407.536"
      >
        <circle cx="130.536" cy="407.536" r="125" fill="#19447B" />
        <circle
          cx="130.536"
          cy="407.536"
          r="127.5"
      ...
      <g
        ...
        cy="477"
      >
        <circle cx="469" cy="477" r="150" fill="#19447B" />
        <circle
          cx="469"
          cy="477"
          r="152.5"
